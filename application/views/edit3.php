...
<body>
 ...
 <!--  <div class="row">
  ...
  <div class="row m-5" id="save">
					<div class="col-md-12" id="pdfManager" style="display:none">
                    
						<div class="row" id="selectorContainer">
							<div class="col-3 text-white  card shadow-lg" id="parametriContainer">
              <div class="row m-2 ">
                              <div class="col-lg-12">
      ...
      -->                     
                              ...
                              <button class="btn btn-success btn-block add_text" >Add</button>
                              </div>
                      </div>
                       <div class="row" id="parametriContainer1">
                       </div>
              </div>
							<div class="col-9 bg-dark p-0 m-0">
...
pdfjsLib.GlobalWorkerOptions.workerSrc =
  ...
  loadingTask.promise.then(function(pdf) {
    ...
    console.log(x);
    for(let i=1;i<=x;i++){
    $( "#pageContainer" ).append(`<canvas id="the-canvas-${i}" class="the-canvas" style="border:1px  solid black;margin-left:80px;"></canvas>`);
  ...
  function renderizzaPlaceholder(currentPage){
			...
			for (i = 0; i < parametri.length; i++) {
                ...
                //alert(x+"&"+y);			
				$("#parametriContainer").append('<div class="'+classStyle+'" id="p-'+i+'" data-id="-1" data-page="'+0+'" data-toggle="'+valore+'" data-valore="'+valore+'" data-x="'+x+'" data-y="'+y+'" style="transform: translate('+x+'px, '+y+'px);font-size:'+f+'px;" > <span class="descrizione">'+param.text+'</span><i class="material-icons  text-danger" id="'+i+'" onclick="myFunction(this)">clear</i></div>');
...
<div class="container-fluid bg-dark text-white mt-5 p-0" style="width:100%;">
   <div class="row">
     <div class="col-lg-4">
