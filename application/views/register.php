...
<div class="container d-flex justify-content-center" style="margin-top:40px;">
    ...
    <!-- form action='<?= base_url("index.php/upload/register"); ?>' method="POST" name="registration"> -->
    <?php echo form_open('upload/register'); ?>

      <h1 class="h2 m-3 font-weight-normal text-center lead" style=" font-family: 'Raleway', sans-serif;">Sign Up Form</h1>
      <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" name="password_confirm"  required>
    </div>
    <!-- <b
    <!-- <b
      ...
      <div class="col-md-6">
       <button type="button" class="btn btn-success btn-block" onclick="window.location='<?php echo site_url('upload/login');?>'">Login</button>
       </div>
