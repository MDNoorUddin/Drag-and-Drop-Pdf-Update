    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href='<?= base_url("index.php/admin2/index"); ?>'>
        ...
        <li><a href='<?= base_url("index.php/admin2/index"); ?>'><i class="fa fa-sign-out"></i> <span>Sign Out</span></a></li>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <!-- small box -->
                    <div class="card shadow-lg p-4">
                        <div class="inner">
                            <h5 class="text-center text-white bg-primary p-2"><?php echo strtoupper($text['name']); ?></h5>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href='<?= base_url("index.php/admin2/show_all_individual_pdf_new/".$text['user_id']."/"); ?>' class="small-box-footer">PDF's <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                            <div class="col-6">
                                <a href='<?= base_url("index.php/admin2/show_user_activity_new/".$text['user_id']."/"); ?>' class="small-box-footer">Activities<i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                ...
                <?php
                  ...
                  {
                      ?>
                      <h1 class="display-4" style="margin-left:450px;margin-top:200px;">No User Available</h1>
                  <?php
                  }
           ?>
        </div>
