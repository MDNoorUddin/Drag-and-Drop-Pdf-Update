      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="e">
            ...
            <div class="box-body">
              <ul class="todo-list">
              <?php $i=0;  foreach ($activity as $text):?>
                  ...
                  <?php
                     ...
                     if($text['TYPE']=="login")
                     {?>
                          <span class="text"><?php echo $text['NAME']; ?> Logged in at</span>
                          <small class="label label-secondary"><i class="fa fa-clock-o"></i> </small>
                          <span class="text"></span>
                  
                          <small class="label label-secondary"><i class="fa fa-clock-o"></i><?php echo $text['created_at']; ?></small>
                     <?php } 
                     if($text['TYPE']=="update")
                     {?>

                          <span class="text"><?php echo $text['NAME']; ?> <?php echo $text['activity']; ?> at </span>
                          <small class="label label-secondary"><i class="fa fa-clock-o"></i> </small>
                          <span class="text"></span>
                     ...
                     {?>
                         ...
                         <small class="label label-secondary"><i class="fa fa-clock-o"></i><?php echo $text['created_at']; ?></small>
                     <?php }
                     if($text['TYPE']=="register")
                     {?>

                          <span class="text"><?php echo $text['NAME']; ?> registered at </span>
                          <small class="label label-secondary"><i class="fa fa-clock-o"></i> </small>
                          <span class="text"></span>
          ...
          <!-- /.box -->
                ...
                if($i<=1)
                {?>
                  <h1 class="display-4" style="margin-left:550px;margin-top:200px;">No Activities Found</h1>
                  <?php
                }
                ?>
          <!-- quick email widget -->
