...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <tr class="table-active">
      ...
      <td class="text-center"><a href='<?= base_url("index.php/admin2/pdf_version/".$text['pdf_name']."/".$text['edit_id']."/"); ?>' class="btn btn-success">View Version</a></td>
    </tr>
     <?php endforeach;?>
     </tbody>
     </table>
     <?php
                  ...
                  {
                      ?>
                      <h1 class="display-4 text-primary" style="margin-left:550px;margin-top:200px;">No Edit History Found</h1>
                  <?php
                  }
           ?>
