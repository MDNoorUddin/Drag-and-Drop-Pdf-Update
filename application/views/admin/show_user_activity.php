      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link active" href='<?= base_url("index.php/admin2/index"); ?>'>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Activity of <?php echo $activity[0]['NAME'];?></h1>
          ...
          <?php $i=0; ?>
            <div class="col-lg-12">
                ...
                <table class='table table-hover border table-striped bg-light shadow-lg'>
                  ...
                  {
                      ?>
                      <h1 class="display-4" style="margin-left:450px;margin-top:200px;color:rgb(7, 123, 240);">No Activity Found</h1>
                  <?php
                  }
           ?>
                    </div>
