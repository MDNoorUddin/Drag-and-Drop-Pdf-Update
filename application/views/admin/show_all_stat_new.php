        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">All Statistics</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <?php $i=0; ?>
            <div class="col-lg-12">
                <table class='table table-hover border table-striped bg-light shadow-lg'>
                   <thead>
                     ...
                     <th>Name</th>
                     <th>Email</th>
                     <th>First PDF creation Date</th>
                     <th>Last PDF creation Date</th>
                     <th>Number Of Edits</th>
                     </tr>
                   </thead>
                   <tbody>
                        <?php //print_r($stat); 
                        foreach ($stat as $text): $i++;?>
                        <tr class="shadow-lg spacer table-light">
                           <td><?php echo $i; ?></td>
                           <td><?php echo $text['username']; ?></td>
                           <td><?php echo $text['email']; ?></td>
                           <td><?php if(is_null($text['first Creation date'])) echo('Empty'); else  echo $text['first Creation date']; ?></td>
                           <td><?php if(is_null($text['Last creation date'])) echo('Empty'); else  echo $text['Last creation date']; ?></td>
                           <td><?php if(is_null($text['Last creation date'])) echo('Empty'); echo $text['Edits']; ?></td>
                        </tr>
                        <?php endforeach;?>
                   </tbody>
                   </table>
